...
public class ProductController {
    ...
    @GetMapping
    @Operation(summary = "List all products", description = "Retrieves a complete list of all products currently in the warehouse inventory.")
    public Flux<Product> getAllProducts() {
        return repository.findAll();
    }

    @GetMapping("/{id}")
    @Operation(summary = "Get a product by ID", description = "Retrieves details of a specific product based on its unique ID.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Add a new product", description = "Creates a new product record in the inventory. The ID will be auto-generated.")
    @ApiResponses(value = {
    ...
    public Mono<ResponseEntity<Product>> updateProduct(
        ...
        return repository.findById(id)
                .flatMap(existing -> {
                    Product updated = new Product(id, product.sku(), product.name(), product.quantity(), product.location());
    ...
    @Operation(summary = "Delete a product", description = "Removes a product from the warehouse inventory by its ID.")
